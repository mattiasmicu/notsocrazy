...
export const games: Game[] = [
  ...
  },
  {
    ...
    "title": "Traffic Rider",
    "description": "Traffic Rider is a first-person driving bike endless game that puts you on a motorbike for an exhilarating ride. With a full career mode, lifelike bike sounds, and detailed graphics, it redefines arcade racing.",
    "category": "Other",
  ...
  },
  {
    ...
    "title": "RocketGoal.io",
    "description": "RocketGoal.io is an IO sports game where you drive around a soccer field to compete in intense matches against other players. Drive rocket-powered cars across the arena, show off wild aerial moves, and of course, score as many goals as possible.",
    "category": "Other",
  ...
  },
  {
    ...
    "title": "Open House",
    "description": "Open House is a puzzle match-3 game where you&amp;#39;re unexpectedly tasked with turning an abandoned residence into your dream home via one puzzle at a time. Each puzzle brings about new furnishings and upgrades to keep you hooked.",
    "category": "Other",
  ...
  },
  {
    ...
    "description": "8 Ball Pool Billiards Multiplayer is a competitive sports pool game that lets you test your skills in exhilarating 2-player matches against friends or go head-to-head with players from around the world. Perfect your game by competing against expert bots to sharpen your strategies and techniques.",
    "category": "Other",
  ...
  },
  {
    ...
    "description": "Farm Ring Idle is a circular farming simulation that challenges you to expand outward from a tiny central plot into a thriving, automated ring of crops. Grow vegetables, unlock smart upgrades, and deploy robotic helpers to streamline your harvest.",
    "category": "Other",
  ...
  },
  {
    ...
    "description": "Worldguessr is a casual quiz game, a free alternative to Geoguessr, perfect for testing and expanding your geography skills through immersive Street View exploration. Each round, you will find yourself dropped into random locations around the globe, with only environmental clues to guide you in pinpointing your exact whereabouts.",
    "category": "Other",
  ...
  },
  {
    ...
    "description": "Rally Racer Dirt is a rally drift-based game, allows you to drift on both asphalt and dirt terrains while navigating through hills. This category is redefined with the introduction of Rally Racer Dirt, offering the best realistic and stunning controls for a rally game.",
    "category": "Other",
  ...
  },
  {
    ...
    "description": "Mini Golf Club is a realistic 3D mini golf simulator with fun gameplay and hundreds of challenging levels.The game combines beautiful graphics, realistic physics and easy-to-use controls. Mini Golf Club is challenging yet fun golf game for all ages.",
    "category": "Other",
  ...
  },
  {
    ...
    "description": "MX Offroad Master is a driving bike game where you cycle down steep mountain slopes. Hop on any of the four mountain bikes and get ready for high-octane stunts.",
    "category": "Other",
  ...
  },
  {
    ...
    "title": "Sandbox City",
    "description": "Sandbox City - Cars, Zombies, Ragdolls! is a zombie game where you can explore freely and drive around the city, but, be careful of the zombie&amp;#39;s infection!",
    "category": "Other",
  ...
  },
  {
    ...
    "title": "Doodle Road",
    "description": "Doodle Road is an imaginative and captivating 2D casual game that combines creativity with problem-solving. In this fun browser game, your primary objective is to draw a path that will successfully guide a car from the starting point to the finish line.",
    "category": "Other",
  ...
  },
  {
    ...
    "description": "Driving School Simulator is a simulation driving game that puts your skills to the test. Follow the rules, pass your exams, and earn your license, or make too many mistakes and find yourself back in driving school.",
    "category": "Other",
  ...
  },
  {
    ...
    "title": "Escape Road 2",
    "description": "Escape Road 2 is a fast-paced driving game that throws you into a high-speed chase with law enforcement after a bank heist. Collect rewards to upgrade your car and push your speed even further.",
    "category": "Other",
  ...
  },
  {
    ...
    "title": "BasketBros",
    "description": "BasketBros is a fast-paced basketball game that offers both online and offline gameplay. Choose a player, customize your style, and compete in single-player and multiplayer games.",
    "category": "Other",
